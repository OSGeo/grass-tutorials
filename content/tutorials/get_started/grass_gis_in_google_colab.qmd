...
Let's show the current GRASS settings and check if the session actually
works:
...
# Start GRASS in an existing project

Either if you just created the project and want to start GRASS there or if 
you already have your GRASS projects in GDrive, you just need to start GRASS 
wherever the project is, as shown above, given that GRASS has been 
