...
tools.r_in_ssurgo(ssurgo_path="gSSURGO_NC.zip", soils=f"soils_{huc12}", hydgrp=f"hydgrp_{huc12}", nprocs=1)
...
depth = [row["values"] for row in depths["table"]["rows"] if row["duration"] == f"{duration}-hr"][0]["50"]
print(depth)
```
