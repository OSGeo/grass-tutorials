...
This will prevent concurrent writing to a single database.
...
To get an approximate rainfall depth, we will model a 10-year storm event
...
We will then create an input rainfall depth raster, assuming uniform rainfall:
