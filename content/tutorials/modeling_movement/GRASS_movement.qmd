...
This tutorial uses one of the standard GRASS sample data sets: [flagstaff_arizona_usa](https://grass.osgeo.org/sampledata/flagstaff_az_usa_epsg6341.zip).
...
:::{.smaller}
*© Michael Barton and Anna Petrasova 2026*
