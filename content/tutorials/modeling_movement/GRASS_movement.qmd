...
author: "Michael Barton & Anna Petrosova"
date: 2025-02-10
date-modified: today
format: 
  html:
...
# © Michael Barton & Anna Petrosova 2025
---
...
-   GRASS [***r.walk***](https://grass.osgeo.org/grass-stable/manuals/r.walk.html) generates a cumulative cost surface using Naismith's rule for walking times where each cell has the value in **seconds** of the time it takes to walk from the start point to that cell.
:::
...
2.  Create a **friction map** with a value of 0 (or other vallues for additional movement costs).
...
-   The GRASS [*map calculator*](https://grass.osgeo.org/grass-stable/manuals/r.mapcalc.html) lets you create a map, alter a map or combine maps using **map algebra**. The map calculator can be used from a GUI or as a command.
