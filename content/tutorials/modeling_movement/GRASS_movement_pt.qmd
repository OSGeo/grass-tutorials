...
format: 
  html:
    ...
    code-fold: false
page-layout: article
categories: [intermediário, avançado, GUI, raster, superfície de custo, caminho de menor custo]
...
5.  Preencha o nome do mapa de saída (*name for new raster map to create*) como *friction0* e insira 0 no campo de expressão.
...
2.  Clique com o botão direito e abra o Gerenciador de Tabela de Atributos (*Attribute
Table Manager*). 
...
::: g-col-6
2.  Digite um nome para o **mapa de direções** (*FMC_directions*) a ser usado para criar um caminho de menor custo.  
