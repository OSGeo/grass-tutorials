...
A course taught at the University of Jena: Automated Earth Observation Processing Work Flows with GRASS GIS and WPS

The idea of this course is to teach about spatio-temporal data processing with focus on satellite data including automated processing workflows provided as web services. Sample dataset used in this course includes LiDAR Data and Earth Observation Time Series. Automated workflows with open source GRASS GIS software and Python programming language.
