...
but same set of layers (such an digital elevation model layer, roads layer),
...
Several are state or county level and have no national
equivalent even within the US (NC OneMap and Wake County GIS).
...
our study area, at some value near 30 m. Instead, `resolution="value"` with `resolution_value=30` pins
the cell size to a round 30 m.
