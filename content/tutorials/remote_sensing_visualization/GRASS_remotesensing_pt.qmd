...
Este tutorial utiliza um dos conjuntos de dados de amostra padrão do GRASS para Flagstaff, Arizona, EUA: [flagstaff_arizona_usa](https://grass.osgeo.org/sampledata/flagstaff_az_usa_epsg6341.zip).
Faremos referência a nomes de lugares nesse conjunto de dados, mas ele pode ser complementado com qualquer um dos [conjuntos de dados de amostra padrão](https://grass.osgeo.org/download/data/) fpara qualquer região, por exemplo, o [conjunto de dados da Carolina do Norte](https://grass.osgeo.org/sampledata/north_carolina/nc_spm_08_grass7.zip).
