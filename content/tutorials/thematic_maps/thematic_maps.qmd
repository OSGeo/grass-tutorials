...
Most GIS software supports the creation of thematic maps from vector objects (points, lines, and areas). GRASS likewise enables the creation of thematic maps from vector data. It also supports the creation of thematic maps from rasters, which represent space a grid of cells or pixels.
...
8. Click OK. Now you will see high schools represented by large red circles.

9. Display the *schools* map again in a new layer above the high schools layer in the layer manager.

10. In the vector properties for this new *schools* layer, enter **GLEVEL='M'** (for middle schools) in the Selection WHERE box, set the "Area fill color" to **yellow**, and set the "Symbol size" to **20**.

11. Click OK. Now, along with high schools, you will see middle schools represented by slightly smaller, yellow circles.

12. Finally, display *schools* a third time in a new layer above the middle schools layer in the layer manager.  

13. In the vector properties for this layer, enter **GLEVEL='E'** (for elementary schools) in the Selection WHERE box, set the "Area fill color" to **blue**, and set the "Symbol size" to **15**.  

14. Click OK. Now, along with high schools and middle schools, you will also see elementary schools represented by even smaller, blue circles.  
...
:::{.smaller}
*The development of this tutorial was funded in partby the US
