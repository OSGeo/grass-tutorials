...
format: 
  html:
    ...
    code-fold: false
page-layout: article
categories: [intermediate, advanced, GUI, raster, least cost path]
image: images/thumbnail.webp
description: We will use *r.walk* and *r.path* to determine the best walking path to reach a destination.
engine: jupyter
execute: 
  eval: false
jupyter: python3
...
::: g-col-6
![r.walk tool: select input maps](images/GRASS_movement_6.webp)
:::
:::::
...
::: g-col-6
![r.walk tool: outdir parameter](images/GRASS_movement_7.webp)
:::
:::::
...
:::
::: g-col-6
![r.walk tool: start_points parameter](images/GRASS_movement_8.webp){fig-align="left" width="100%"}
:::
::::::
...
:::
::: g-col-6
![r.walk tool: stop_points parameter](images/GRASS_movement_9.webp)
:::
:::::
...
:::
::: g-col-6
![r.walk tool: walking parameters](images/GRASS_movement_10.webp)
:::
:::::
...
:::
::: g-col-6
![r.walk tool: select *knight's move*](images/GRASS_movement_11.webp)
:::
:::::
...
![The new friction surface map](images/GRASS_movement_23.webp)
...
See [Compute cumulative cost surface section](#compute-cumulative-cost-surface)
...
See [Least cost path section](#least-cost-path)
...
![The original LCP with terrain only is shown by the blue line. The LCP with a landcover friction surface is shown by the heavier yellow line](images/GRASS_movement_25.webp)
